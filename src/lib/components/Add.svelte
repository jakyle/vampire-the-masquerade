<script lang="ts">
	...
	import type { Character, AttributeValue, SkillValue } from '../model/character.model';
...
>
	<div class="flex h-16 w-full flex-row justify-between">
		<div>
			<label
				for="name"
				class="mb-2 block text-sm font-medium uppercase text-stone-900 dark:text-white">name</label
			>
			<input
				id="name"
				autocomplete="off"
